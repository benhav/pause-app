...
export default function HomeClient({ initialLocale }: { initialLocale: Locale }) {
  ...
  return (
    <main
      className={[
        "min-h-[100svh] w-full",
        // ✅ Mobil: behold helt som før
        "px-0 py-0",
        // ✅ Tablet: kun horisontal “ramme” + litt luft, uten å kødde med mobil
    ...
    >
      <div
        className={[
          ...
          // Tablet: match mockup-bredde (ikke super-smalt, ikke full bredde)
      ...
      >
        <Card>
          {step === "welcome" && (
            <>
              {/* ✅ Mobil: uendret. ✅ Tablet: litt mer “rolig” topp-rytme (ikke gigantisk) */}
              ...
              <div className="absolute bottom-6 left-0 right-0 px-6 md:px-10">
                <button
                  ...
                  className={[
                    // ✅ Litt mindre dominerende på tablet (men samme på mobil)
          ...
          {step === "capacity" && (
            <div
              className={[
                ...
                // ✅ Mobil: full-height flow som før
                "min-h-[100svh]",
                // ✅ Tablet: IKKE tving 100svh inni Card (det er det som gir “hopping”/scroll)
                "md:min-h-0",
              ].join(" ")}
            >
              ...
              {/* ✅ Tablet: litt mer luft før “Today”, men ikke ekstremt */}
              ...
              {/* ✅ Mobile behold (mt-10). ✅ Tablet: flytt valg litt OPP (mindre spacer) */}
              ...
              {/* ✅ Litt bunn-luft uten å tvinge scroll på tablet */}
          ...
          {step === "load" && (
            ...
            >
              ...
              {/* ✅ Mobile som før. ✅ Tablet: valg litt opp */}
