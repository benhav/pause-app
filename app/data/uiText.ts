...
export const UI_TEXT = {
  en: {
    ...
    // THEME (EN)
    themeTitle: "Theme",
    themeClassic: "Classic (Free)",
    themeFloating: "Floating (Pro)",
    themeNature: "Nature (Pro)",
    themeNightfirst: "Night-first (Pro, night)",
    themeNightfirstNote: "(auto → Classic in day mode)",
    themeProLocked: "This is a Pro feature.",
    themeActivateProDemo: "Activate pro-demo",
    themeDeactivateProDemo: "Deactivate pro-demo",
  ...
  no: {
    ...
    breathingRoomTitle: "Pusterom",
    hideElements: "Skjul elementer",
    showElements: "Vis elementer",
    speedAria: "Juster tempo",
    resetSpeed: "Nullstill",
    openBreathingRoom: "Åpne pusterom",
    followRhythm: "Følg rytmen",

    // THEME (NO)
    themeTitle: "Tema",
    themeClassic: "Classic (Gratis)",
    themeFloating: "Floating (Pro)",
    themeNature: "Nature (Pro)",
    themeNightfirst: "Night-first (Pro, natt)",
    themeNightfirstNote: "(auto → Classic i dagmodus)",
    themeProLocked: "Dette er en Pro-funksjon.",
    themeActivateProDemo: "Aktiver pro-demo",
    themeDeactivateProDemo: "Deaktiver pro-demo",
